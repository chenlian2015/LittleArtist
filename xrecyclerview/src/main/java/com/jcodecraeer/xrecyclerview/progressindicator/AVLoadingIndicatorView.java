...
import com.jcodecraeer.xrecyclerview.progressindicator.indicator.EjiaziIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    public static final int EJiaZi = 28;
    ...
    private void applyIndicator() {
        switch (mIndicatorId) {
            ...
            case SemiCircleSpin:
                ...
                break;
            case EJiaZi:
                mIndicatorController = new EjiaziIndicator();
                break;
            default:
                break;
        }
